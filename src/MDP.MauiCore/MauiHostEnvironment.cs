...
namespace MDP.MauiCore
{
    ...
    {
        // Constructors
        public MauiHostEnvironment(IEnvironmentVariables environmentVariables, Assembly entryAssembly)
        {
            #region Contracts
            ...
            // EnvironmentName
            var environmentName = environmentVariables.GetVariable("EnvironmentName");
