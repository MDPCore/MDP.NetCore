...
{
    internal abstract partial class ServiceRegister
    {
        // Properties
    ...
    internal class ServiceRegister<TService> : ServiceRegister
        where TService : class
    {
        ...
        // Constructors
        public ServiceRegister(string instanceName, Func<IServiceProvider, object> resolveAction)
        {
            #region Contracts
